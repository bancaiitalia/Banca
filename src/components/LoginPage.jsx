...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormError(err.message || 'Errore durante l\'accesso');
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-md w-full p-8 shadow-lg">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Accesso</h2>
          <p className="text-gray-600 mt-2">Accedi al tuo spazio clienti</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              {formData.username.length}/11 cifre
            </p>
          </div>
          ...
          <div>
            ...
            <input 
              ...
              disabled={loading}
              readOnly
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 cursor-pointer"
              placeholder="••••••"
            />
          </div>
